...
export function seedDatabase() {
  ...
  if (!existingProfile) {
    ...
    dbRun("INSERT INTO school_profile (data) VALUES (?)", [
    ...
    const grants = [
      {
        ...
        is_expired: 0,
        description:
          "Supporting innovative STEM education models in Sub-Saharan Africa with focus on technology integration, teacher training, and scalable curriculum development.",
      ...
      },
      {
        ...
        is_expired: 0,
        description:
          "Empowering schools to integrate AI and machine learning into curricula across developing nations, with emphasis on ethical AI education and practical applications.",
        eligibility: JSON.stringify([
      ...
      },
      {
        ...
        is_expired: 0,
        description:
          "Supporting schools in developing inclusive education models that serve children with disabilities and diverse learning needs.",
        eligibility: JSON.stringify([
      ...
      },
      {
        ...
        is_expired: 0,
        description:
          "Funding innovative use of technology in education across Commonwealth nations, focused on bridging the digital divide.",
        eligibility: JSON.stringify([
      ...
      },
      {
        ...
        is_expired: 0,
        description:
          "Enabling young people in Africa to access quality education and develop leadership skills for transforming their communities.",
        eligibility: JSON.stringify([
          "African institution",
      ...
      },
      {
        ...
        is_expired: 0,
        description:
          "Promoting hands-on robotics and innovation labs within schools across Africa, emphasizing practical skills for future workforce readiness.",
        eligibility: JSON.stringify([
    ...
    for (const g of grants) {
      dbRun(
        ...
        [
          ...
          g.requirements,
          g.readiness_score,
          g.estimated_success_rate,
          g.source,
        ],
      );
    }
    console.log("✓ Seeded 7 grants");
  }
    ...
    const notifications = [
      {
        ...
        message:
          'AI found "Africa STEM Education Innovation Grant" — 78% match',
        priority: "HIGH",
      },
      {
        type: "DEADLINE",
        title: "Deadline Approaching",
        message: "USAID Robotics grant deadline in 72 days",
        priority: "URGENT",
      },
      {
        type: "SYSTEM",
        ...
        message:
          "AI Agent scan completed. 7 grants found, 4 high-relevance matches.",
        priority: "LOW",
      },
      {
        type: "GRANT_FOUND",
        title: "Google AI Grant Available",
        message:
          "New $100K-$500K grant from Google.org for AI education — 85% match",
        priority: "HIGH",
      },
      {
        type: "DEADLINE",
        title: "UNICEF Fund Closing Soon",
        message: "UNICEF Inclusive Education Fund deadline in 92 days",
        priority: "MEDIUM",
      },
    ];
